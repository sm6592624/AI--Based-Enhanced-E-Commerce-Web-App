    ...
    return (
        <div className="container mx-auto px-6 py-12">
            <div className="text-center mb-12">
                ...
                {usingMockData && (
                    <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mt-4 max-w-md mx-auto">
                        Currently showing demo data. {error && `(${error})`}
                    </div>
                )}
            </div>
                        ...
                        <div className="relative h-64">
                            <img 
                                ...
                                onError={(e) => {
                                    ...
                                    e.target.src = 'https://placehold.co/400x600/F9FAFB/374151?text=Fashion+Trend';
                                }}
                            />
            ...
            <div className="text-center mt-12">
                ...
                >
                    {usingMockData ? 'Try Real API' : 'Refresh Trends'}
                </button>
            </div>
        </div>
    );
